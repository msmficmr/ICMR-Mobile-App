      ...
      return InkWell(
        onTap: () {
          if (chatBotProvider.isNextSuggestionClickable) {
            ...
            _questionnairesRepository.conversation.first.answer = _questionnairesRepository.conversation.first.options[index];
            ...
            if (_questionnairesRepository.conversation.first.chipType == AppConstant.SINGLE_CHOICE_TOGGLE_TEXTFORM ||
              ...
              if (_questionnairesRepository.conversation.first.followupQuestions[_questionnairesRepository.conversation.first.optionKeys[index]] == null) {
                chatBotProvider.onUserSelectsOption(conversationModel: _questionnairesRepository.conversation.first, context: context);
              }
            } else {
        ...
        child: Container(
          ...
          child: Container(
            ...
            child: Text(
              ...
              softWrap: true,
              style: const TextStyle(fontSize: 14, textBaseline: TextBaseline.ideographic, height: AppConstant.TEXT_HEIGHT, color: AppColorScheme.kGrayColor),
            ),
          ),
        ),
      );
